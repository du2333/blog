        ...
        <div className="group flex flex-col sm:flex-row py-10 gap-8 sm:gap-0 border-b border-zinc-100/60 dark:border-white/[0.02]">
          ...
          <div className="flex-1 space-y-8">
            <div className="max-w-xl">
              <h4 className="text-base font-medium text-zinc-950 dark:text-zinc-50 mb-3 tracking-tight">重建搜索映射</h4>
          ...
          <div className="flex-1 space-y-8">
            <div className="max-w-xl">
              <div className="flex items-center gap-3 mb-3">
                <h4 className="text-base font-medium text-zinc-950 dark:text-zinc-50 tracking-tight">全局缓存清理</h4>
