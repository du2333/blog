		...
		<div className="space-y-16 animate-pulse">
			...
			<div className="space-y-px">
				{[1, 2, 3].map((i) => (
					<div
						key={i}
						className="flex flex-col sm:flex-row py-10 gap-4 sm:gap-0 border-b border-zinc-100/60 dark:border-white/[0.02]"
					>
						...
						<div className="flex-1 space-y-4">
							...
							{i === 3 && (
								<div className="h-12 w-48 bg-zinc-100 dark:bg-zinc-900 rounded-sm mt-8"></div>
							)}
						</div>
					</div>
				))}
