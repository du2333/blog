export function PostEditorSkeleton() {
  return (
    <div className="fixed inset-0 z-50 flex flex-col bg-white dark:bg-[#050505] overflow-hidden animate-pulse">
      {/* Header Skeleton */}
      <header className="h-20 flex items-center justify-between px-8 shrink-0 bg-white/80 dark:bg-[#050505]/80 backdrop-blur-md">
