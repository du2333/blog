		...
		<div className="w-full max-w-7xl mx-auto px-6 md:px-10 py-20 space-y-24">
			...
			<div className="min-h-[60vh] flex flex-col justify-center space-y-8">
				<div className="space-y-4">
					...
					<div className="h-20 w-3/4 bg-muted animate-pulse rounded"></div>
					<div className="h-20 w-1/2 bg-muted animate-pulse rounded"></div>
				</div>
				<div className="h-6 w-2/3 bg-muted animate-pulse rounded"></div>
				<div className="h-12 w-40 bg-muted animate-pulse rounded-full"></div>
			</div>
			...
			<div className="flex flex-col border-t border-border">
				{[1, 2, 3, 4].map(i => (
					...
					>
						<div className="md:col-span-1 h-4 w-8 bg-muted animate-pulse rounded"></div>
