/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface Env` (hash: dcfae6aed87138cbca66a40af45f599d)
...
declare namespace Cloudflare {
	...
	interface Env {
		...
		GOOGLE_ANALYTICS_SECRET_KEY: string;
		R2: R2Bucket;
		DB: D1Database;
		POST_PROCESS_WORKFLOW: Workflow /* PostProcessWorkflow */;
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "NODE_ENV" | "CLOUDFLARE_ACCOUNT_ID" | "CLOUDFLARE_DATABASE_ID" | "CLOUDFLARE_D1_TOKEN" | "GOOGLE_ANALYTICS_SECRET_KEY">> {}
}
